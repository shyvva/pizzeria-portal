...
const app = {
  initPages: function () {
    ...
    thisApp.activedPage(pageMatchingHash);
    ...
    for (let link of thisApp.navLinks) {
      link.addEventListener('click', function (event) {
        ...
        /* run this.App.activedPage with that id */
  ...
  initCart: function () {
    ...
    thisApp.produtList = document.querySelector(select.containerOf.menu);

    thisApp.produtList.addEventListener('add-to-cart', function (event) {
